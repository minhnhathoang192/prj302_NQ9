 ...
 * @author NQ9
 */
public class addSongToPlaylistController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean result = pdao.addSongToPlaylist(playlistID, songID);
            
            if(result){
                System.out.println("Them Nhac thanh cong");
            }else{
                System.out.println("Them nhac khong thanh cong");
            }
        ...
        response.sendRedirect("MainController?action=manage_playlist");
    }
