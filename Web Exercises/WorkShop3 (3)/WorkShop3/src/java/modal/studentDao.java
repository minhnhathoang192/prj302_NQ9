...
public class studentDao {
    ...
    public List<studentDto> searchByID(String id) {
        return searchByColumn("studentID", id);
    }

    public List<studentDto> searchByName(String name) {
        return searchByColumn("fullName", name);
    }
    ...
    private List<studentDto> searchByColumn(String column, String value) {
        List<studentDto> list = new ArrayList<>();
        try {
            Connection conn = DbUtils.getConnection();
            PreparedStatement ps = conn.prepareStatement(""
                    + "SELECT * FROM tblStudent WHERE " + column + " = ? ");
