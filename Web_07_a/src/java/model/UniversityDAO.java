...
public class UniversityDAO {
    ...
    private ArrayList<UniversityDTO> searchByColum(String colum, String value) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                int foundYear = rs.getInt("foundYear");
                ...
                UniversityDTO u = new UniversityDTO(id, name, shortName, description, foundYear, address, city, region, type, totalStudents, totalFaculties, isDraft);
                result.add(u);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private ArrayList<UniversityDTO> filterByColum(String colum, String value) {
        ArrayList<UniversityDTO> result = new ArrayList<>();
        try {
            Connection conn = DbUtils.getConnection();
