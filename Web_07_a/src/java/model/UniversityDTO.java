...
public class UniversityDTO {
    ...
    public String toString() {
        return "UniversityDTO{" + "id=" + id + ", name=" + name + ", shortName=" + shortName + ", description=" + description + ", foundedYear=" + foundedYear + ", address=" + address + ", city=" + city + ", region=" + region + ", type=" + type + ", totalStudents=" + totalStudents + ", totalFaculties=" + totalFaculties + ", isDraft=" + isDraft + '}';
    }
}
